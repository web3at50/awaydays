...
against the project's cached public key (JWKS) — no Auth server round trip
...
arrives, say — and must run wherever the schema does. Trip content —
entries, diary text, summaries, covers, travel legs — is **user data**: it
